...
class laswriter:
	...
	def writepoints(self):
		...
		'''
		xs = self.hdr.Xscalefactor #* 10
		ys = self.hdr.Yscalefactor #* 10
		zs = self.hdr.Zscalefactor #* 10
